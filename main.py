...
additions = ["без дизайна", "с стемпингом", "с наклейками", "со стразами", "с втиркой", "с градиентом", "с фигурками",\
"с обьемными линиями", "с фольгой", "с глитером", "со слайдерами", " с рисунком", "с пирсингом", "с мрамором", "с графити"\
, "с разводами"]
...
def randomnogotochki(message):
    if message.text == "Случайные ноготочки":
        ...
        m = f"Ваши ногти это {w} {l} {c} формы {f} {a}"
